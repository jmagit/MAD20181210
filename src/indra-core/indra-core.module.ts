...
@NgModule({
  declarations: [ PIPES_CADENAS, PIPES_NUMERICOS, MIS_VALIDADORES, IndraSizerComponent ],
  exports: [ PIPES_CADENAS, PIPES_NUMERICOS, MIS_VALIDADORES, IndraSizerComponent ],
  imports: [
    CommonModule
  ],
})
